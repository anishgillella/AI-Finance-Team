 ...
 */
export async function getCoreSchemaDescription() {
    const schema = await loadSchemaRegistry();
 ...
 */
export async function validateTableName(tableName) {
    const schema = await loadSchemaRegistry();
 ...
 */
export async function validateColumn(tableName, columnName) {
    const schema = await loadSchemaRegistry();
 ...
 */
export async function isColumnAggregatable(tableName, columnName) {
    const schema = await loadSchemaRegistry();
    const table = schema[tableName];
